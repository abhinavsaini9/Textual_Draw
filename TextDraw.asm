...
screenColumns WORD 100           . no of columns in screen
screenRows WORD 100              . no of rows in screen  (screenColumns and screenRows should be same in simulator settings as intialized here)
screenLength WORD 10000
